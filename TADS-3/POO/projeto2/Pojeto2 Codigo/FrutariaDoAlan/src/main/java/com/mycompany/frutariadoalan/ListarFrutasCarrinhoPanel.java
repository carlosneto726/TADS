...
public class ListarFrutasCarrinhoPanel extends JPanel {
    private Frutas fruta;    
    
    /* 
    ListarFrutasCarrinhoPanel é um Panel para listar o carrinho 
    no JPanelListarCarrinho server para listar todas as compras feitas
    */
    
    public ListarFrutasCarrinhoPanel() {
        initComponents();        
    }    
    public ListarFrutasCarrinhoPanel(Frutas fruta) {
        initComponents();
        this.fruta = fruta;
    ...
    con.removerFrutaDoCarrinho(codigo); // Excluindo no banco de dados a fruta especificada.
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        con.atualizarCarrinho(nome, quantidade, codigo); // Atualizando todas as informaçoes para o BD.
