...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" id="last_nav_link" href="<?php if($isset){echo "?secao=userloja";}else{echo "?secao=login";}?>"> <?php if($isset){echo "Sua Loja";}else{echo "Login";}?></a>
            </li>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <form action="adm/sair.php" method="post">
            <button class="btn btn-danger me-md-2" id="sair-btn" type="submit" <?php if(!($isset)){echo "hidden";}?> >Sair</button>
        </form>
